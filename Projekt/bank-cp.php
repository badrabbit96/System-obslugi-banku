...
?>
 ...
 <!-- KLIENCI-->
    ...
    Lista klientów banku oraz ich dane: 
  </div>
  ...
  <tbody>
	...
	<?php 
	//,numer_konta,saldo
	$query = sprintf("SELECT dane.login,imie,nazwisko,adres,konta_osobiste.numer_konta,konta_osobiste.saldo FROM `dane` LEFT JOIN konta_osobiste on dane.login = konta_osobiste.login");
